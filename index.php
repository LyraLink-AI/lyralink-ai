...
<head>
    ...
    <meta name="description" content="Lyralink is the AI operating system for work that needs memory, planning, tools, and operator control — not just another chatbot.">
    <meta name="keywords" content="AI operating system, AI execution platform, AI workspace, operator AI platform, Lyralink, LyralinkAI">
    ...
    <style>
        :root {
            ...
            --accent-ink: #f0e7ff;
            --secondary: #38bdf8;
            --secondary-soft: rgba(56, 189, 248, 0.16);
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            background:
                ...
                radial-gradient(circle at bottom right, rgba(124,58,237,0.14), transparent 26%),
                linear-gradient(180deg, #0a0a16 0%, #05050b 100%);
            min-height: 100vh;
        }
        body::before {
            content: '';
        ...
        .nav-link:hover { background: rgba(124,58,237,0.12); color: var(--text); }
        .nav-link.primary {
        ...
        .hero-copy, .hero-panel, .section-card, .timeline, .faq-shell, .footer-shell {
        ...
        .workspace-card {
            background: linear-gradient(180deg, rgba(18, 16, 34, 0.96), rgba(9, 9, 16, 0.98));
            border: 1px solid rgba(124,58,237,0.20);
            border-radius: 24px 24px 18px 30px;
            padding: 22px;
        }
        ...
        .section-card li::before { content: '•'; color: var(--secondary); margin-right: 8px; }
        ...
        .cta-card {
            background: linear-gradient(135deg, rgba(124,58,237,0.22), rgba(56,189,248,0.10));
            border: 1px solid rgba(124,58,237,0.28);
            border-radius: 34px 22px 30px 18px;
            padding: 30px;
            display: flex;
            justify-content: space-between;
            gap: 18px;
...
<section class="hero">
    <div class="container hero-grid">
        <div class="hero-copy reveal visible">
            <div>
                <h1>AI that works like an <span>operating system</span>, not a chatbot.</h1>
                <p class="hero-sub">
                    Lyralink is the AI execution platform for work that needs memory, planning, tool use, and operator control.
                    It brings chat, projects, agents, automations, API access, and business controls into one product layer so the experience feels real and usable.
                </p>
                <div class="hero-actions">
                    <a href="/chat" class="btn btn-primary">Open the workspace</a>
                    <a href="/pages/pricing/" class="btn btn-secondary">See pricing</a>
                </div>
            ...
            <div class="hero-notes">
                <span class="note-pill">Mission-based work, not just casual chat</span>
                <span class="note-pill">One workspace for planning, tasks, and execution</span>
                <span class="note-pill">Built to feel like product infrastructure, not a toy</span>
            </div>
        </div>
        <div class="hero-panel reveal visible">
            <div class="workspace-card">
                <div class="workspace-head">
                    <div class="workspace-title">A calmer stack for launching AI products</div>
                    <div class="workspace-tag">AI execution platform</div>
                </div>
                <div class="workspace-list">
                    <div class="workspace-item">
                        <div class="workspace-kicker">Mission</div>
                        <div>
                            <strong>Keep the work moving from prompt to outcome.</strong>
                            <p>Goal tracking, follow-through, iterative planning, and visible progress make the assistant feel operational instead of reactive.</p>
                        </div>
                    </div>
                    <div class="workspace-item">
                        <div class="workspace-kicker">API</div>
                        <div>
                            <strong>Expose the same intelligence through a clean, documented interface.</strong>
                            <p>Keys, limits, and developer access are designed to feel production-ready and safer by default.</p>
                        </div>
                    </div>
                    <div class="workspace-item">
                        <div class="workspace-kicker">Ops</div>
                        <div>
                            <strong>Keep product control and business operations in one place.</strong>
                            <p>Support, status, admin flows, and billing remain close to the experience they support.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="signal-grid">
                <div class="signal"><strong>Workspace</strong><span>Built for actual AI work: planning, coding, research, and structured follow-through.</span></div>
                <div class="signal"><strong>API</strong><span>Developer access with secure defaults, auth, and usage controls.</span></div>
                <div class="signal"><strong>Ops</strong><span>Status, security, admin, and business tools stay aligned with the product.</span></div>
            </div>
        </div>
    </div>
</section>
<section class="section-block" id="product">
    <div class="container">
        <div class="section-header reveal">
            <div>
                <div class="section-kicker">Execution Layer</div>
                <div class="section-title">The product is not the chat. <span>It is the system behind it.</span></div>
            </div>
            <p class="section-desc">
                Good AI products are not just “smart text boxes.” They are clear operating layers: intent, memory, tools, safe defaults, operator control, and a dependable experience that users trust enough to pay for.
            </p>
        </div>
        <div class="three-up">
            <div class="section-card reveal">
                <div class="card-label">01</div>
                <h3>Work-oriented workspace</h3>
                <p>Users need a place that handles real tasks instead of a shallow chat surface with too much noise.</p>
                <ul>
                    <li>Persistent context and goal tracking</li>
                    <li>Planning, debugging, and execution support</li>
                    <li>Designed to feel reliable enough for daily work</li>
                </ul>
            </div>
            <div class="section-card reveal">
                <div class="card-label">02</div>
                <h3>Production-ready API</h3>
                <p>Developers can integrate the same intelligence with documented auth, clear limits, and safer public defaults.</p>
                <ul>
                    <li>Secure headers, lower-risk defaults, and clearer docs</li>
                    <li>Fast path for integrations and developer tooling</li>
                    <li>Operational controls without exposing internal fragility</li>
                </ul>
            </div>
            <div class="section-card reveal">
                <div class="card-label">03</div>
                <h3>Operator control plane</h3>
                <p>The business layer stays close to the product so pricing, support, and status do not drift into disconnected systems.</p>
                <ul>
                    <li>Account-aware plans and credit-based usage</li>
                    <li>Monitoring, support, and infrastructure visibility</li>
                    <li>Clearer operator workflow for sustainable growth</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="section-block">
    <div class="container split-panel">
        <div class="section-card narrative reveal">
            <div class="section-kicker">What You Actually Get</div>
            <div class="section-title">An AI system that feels like <span>a real product</span>, not a prototype.</div>
            <p>The goal is no longer just “can this answer a prompt?” It is whether the product can sustain trust, follow-through, and a fair operating model as real people use it every day.</p>
            <p>That means thoughtful UX, clear trust surfaces, stronger docs, stable API patterns, and operator controls that make the system feel coherent instead of improvised.</p>
        </div>
        <div class="timeline reveal">
            <div class="timeline-step"><div class="timeline-num">1</div><div><strong>Start with the execution stack.</strong><p>Use the hosted workspace, pricing, docs, and operator flows to avoid rebuilding the foundation behind your AI offer.</p></div></div>
            <div class="timeline-step"><div class="timeline-num">2</div><div><strong>Package it around a real workflow.</strong><p>Internal copilots, research agents, client portals, and API access all fit within the same controlled operating layer.</p></div></div>
            <div class="timeline-step"><div class="timeline-num">3</div><div><strong>Improve experience instead of polishing chaos.</strong><p>Focus on onboarding, retention, and trust rather than stacking more features on a confused core.</p></div></div>
        </div>
    </div>
</section>
<section class="section-block" id="operators">
    <div class="container">
        <div class="section-header reveal">
            <div>
                <div class="section-kicker">For Operators</div>
                <div class="section-title">Built for people selling <span>the experience</span>, not just the model.</div>
            </div>
        ...
        <div class="split-panel">
            <div class="section-card reveal">
                <div class="card-label">Where it fits</div>
                <h3>Use it as your branded layer.</h3>
                <p>You can use Lyralink as the main customer-facing workspace, as the operator layer behind another front-end, or as a hybrid setup that mixes chat, API, and embedded access.</p>
                <ul>
                    <li>Agency or client-facing AI workspace</li>
                    <li>Developer-facing API resale or tool layer</li>
                    <li>Discord, desktop, and embedded distribution</li>
                </ul>
            </div>
            <div class="section-card reveal">
                <div class="card-label">Why it helps</div>
                <h3>More calm in the operating model.</h3>
                <div class="mini-grid">
                    <div class="mini-card"><strong>Billing</strong><p>Plan-aware product access and payment return flows are already part of the system.</p></div>
                    <div class="mini-card"><strong>Trust</strong><p>Security reporting, legal pages, and safer AI defaults help the product feel more complete.</p></div>
                    <div class="mini-card"><strong>Reach</strong><p>One backend can support web, desktop, API, and Discord distribution paths.</p></div>
                    <div class="mini-card"><strong>Ops</strong><p>Admin, status, support, and logs live in the same product surface instead of several ad hoc tools.</p></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="section-header reveal">
            <div>
                ...
                <div class="section-title">A few things people usually ask <span>first.</span></div>
            </div>
...
<section class="cta-wrap">
    <div class="container">
        <div class="cta-card reveal">
            <div>
                <h3>Start with the part that already works.</h3>
                <p>Open the workspace if you want to see the product surface first, or go straight to operator pricing if you are evaluating it as infrastructure.</p>
            </div>
            <div class="hero-actions" style="margin:0">
                <a href="/chat" class="btn btn-primary">Open workspace</a>
                <a href="/pages/reseller_apply.php" class="btn btn-secondary">Apply as an operator</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="footer-shell">
            <div class="footer-inner">
                <div class="footer-brand">
                    ...
                    <p class="footer-tagline">AI infrastructure for operators who want the surrounding product to feel considered, not improvised.</p>
                </div>
                <div class="footer-links-group">
                    <h4>Platform</h4>
                    <a href="/chat">AI Workspace</a>
                    <a href="/social">Social Chat</a>
                    <a href="/download">Desktop App</a>
                    <a href="/pages/pricing/">Operator Pricing</a>
                ...
                <div class="footer-links-group">
                    ...
                    <a href="/pages/security.php">Security Policy</a>
                    <a href="/pages/accessibility.php">Accessibility Statement</a>
                    <a href="https://lyralinkai.com" target="_blank" rel="noopener">LyralinkAI</a>
                </div>
            </div>
            <div class="footer-bottom">
                <span class="footer-copy">© <?= date('Y') ?> Lyralink Infrastructure — a LyralinkAI product</span>
                <div class="footer-legal">
                    <a href="/pages/tos/">Terms</a>
                    <a href="/pages/privacy/">Privacy</a>
                    <a href="/pages/security.php">Security</a>
                    <a href="/pages/support/">Support</a>
                    <a href="mailto:support@lyralinkai.com">Contact</a>
                </div>
            </div>
        </div>
    </div>
