 ...
 * Embed: <script src="https://lyralinkai.com/assets/js/widget.js?v=20260912-2" data-ref="TOKEN"></script>
 */
(function () {
    'use strict';
    ...
    var canUseIframeEmbed = ((script && script.dataset.embedMode) || 'iframe') !== 'popup';
...
@media(max-width:480px){\
  ...
  #ll-widget-frame{height:65vh}\
    ...
    loading.innerHTML = '<div id="ll-widget-loading-ring"></div><span>Starting chat…</span>';
