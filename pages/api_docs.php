...
<head>
    ...
    <title>Lyralink — Developer API</title>
    ...
    <style>
        ...
        *::-webkit-scrollbar-corner { background: transparent; }
        ...
        .mobile-toc { display:none; position:sticky; top:53px; z-index:9; padding:10px 12px; border-bottom:1px solid var(--border); background:rgba(10,10,15,0.94); backdrop-filter:blur(10px); gap:6px; overflow-x:auto; }
        .mobile-toc a { color:var(--text-muted); text-decoration:none; font-size:11px; border:1px solid var(--border); border-radius:999px; padding:5px 10px; white-space:nowrap; transition:all 0.2s; }
        .mobile-toc a.active, .mobile-toc a:hover { border-color:var(--accent); color:var(--accent-light); background:rgba(124,58,237,0.12); }
        ...
        @media (max-width: 768px) {
            ...
            .mobile-toc { display:flex; top:45px; }
...
<div class="mobile-toc" aria-label="API docs quick navigation">
    <a href="#intro">Intro</a>
    <a href="#operator-quickstart">Quickstart</a>
    <a href="#auth">Auth</a>
    ...
    <a href="#example-curl">Examples</a>
</div>
...
<div class="layout">
    ...
    <div class="doc-sidebar">
        ...
        <div class="doc-sidebar-section">
            ...
            <a href="#prompt">Prompt Orchestration</a>
            <a href="#search">Search Dataset</a>
            <a href="#benchmark">Public Benchmark API</a>
        </div>
        <div class="doc-sidebar-section">
    ...
    <div class="doc-content">
        ...
        <div class="doc-section" id="intro">
            <h2>Lyralink API</h2>
            <div class="section-sub">Base URL: <span style="color:var(--accent-light)">https://lyralinkai.com/api/public_api.php</span></div>
            <div class="trust-links" aria-label="Trust center links">
                <a class="trust-link" href="/pages/status">Status</a>
                <a class="trust-link" href="/pages/security.php">Security Policy</a>
                <a class="trust-link active" href="/pages/api_docs/">API Docs</a>
                <a class="trust-link" href="/pages/support/">Support</a>
            </div>
            <p>The Lyralink API gives operators and developers a documented, lower-risk way to access searchable knowledge, orchestration-backed prompt execution, and the public benchmark corpus in a production-friendly workflow.</p>
            <p>Prompt completions and dataset search require an API key. Public benchmark read endpoints do not. Keys are generated from your <a href="/pages/api_keys.php" style="color:var(--accent-light)">account dashboard</a> and can be rotated at any time. Rate limits and usage behavior are tied to the plan you choose.</p>

            <div class="callout">
                <strong>Production note</strong>
                Prefer header-based authentication and keep keys out of client-side JavaScript. Query-string keys are intentionally restricted to reduce accidental leakage in shared or public environments.
            </div>
        </div>

        <div class="doc-section" id="operator-quickstart">
            <h2>Operator Quickstart</h2>
            <div class="section-sub">Beginner-friendly path from first launch to scaled operations</div>
            <p>Use this sequence to turn Lyralink into a business-ready operator workflow. It is designed to work for solo founders, agencies, and larger organizations.</p>
            <ul>
                <li>Create your operator account and configure branding in the operator dashboard.</li>
                <li>Generate API keys in <a href="/pages/api_keys.php" style="color:var(--accent-light)">API Keys</a> and keep them server-side only.</li>
                <li>Embed referral widget snippet to capture attributed signups.</li>
                <li>Use usage-aware pricing and monitor billing status to protect margins.</li>
                <li>Expand into team workflows through organization membership and role controls.</li>
            </ul>

            <div class="callout">
                <strong>Recommended launch stack</strong>
                Pair one embed channel (website widget), one programmatic channel (API key integration), and one acquisition channel (invite link) before adding advanced automations.
            </div>

            <div class="code-block">
                <div class="code-block-header"><span class="code-lang">Workflow</span><button class="copy-code-btn" onclick="copyCode(this)">Copy</button></div>
                <pre><code>1) Apply and activate operator account
2) Configure branding + acquisition link
3) Deploy widget and onboard first clients
4) Issue API key for technical integration
5) Track usage, credits, and payout cycles</code></pre>
            </div>
        </div>
        ...
        <div class="doc-section" id="auth">
            ...
            <div class="section-sub">Prompt and search requests require a valid API key</div>
            <p>Pass your API key in headers for authenticated routes. The public benchmark routes are intentionally readable without a key.</p>

            <p style="margin-top:16px"><strong>Option 1 — X-API-Key header (recommended)</strong></p>
            <div class="code-block">
            ...
            <p><strong>Option 2 — Authorization Bearer header</strong></p>
            <div class="code-block">
                <div class="code-block-header"><span class="code-lang">HTTP</span><button class="copy-code-btn" onclick="copyCode(this)">Copy</button></div>
            ...
            <div class="callout warn">
                <strong>Auth transport note</strong>
                Query-string keys (<code>?key=...</code>) are disabled by default for security. Use headers. If Bearer auth is blocked by an intermediate proxy in your environment, use <code>X-API-Key</code>.
            </div>
        ...
        <div class="doc-section" id="prompt">
            <h2>Prompt Orchestration</h2>
            <div class="section-sub">Authenticated POST route backed by the same orchestration layer as /chat</div>

            <div class="endpoint">
                <div class="endpoint-header">
                    <span class="method-badge method-get" style="background:rgba(56,189,248,0.15);color:var(--blue);border-color:rgba(56,189,248,0.3)">POST</span>
                    <span class="endpoint-path">/api/public_api.php?action=prompt</span>
                    <span class="endpoint-desc">Full chat orchestration response</span>
                </div>
                <div class="endpoint-body">
                    <p style="margin-bottom:14px">This route now uses the same orchestration/runtime layer as the main chat endpoint, including routing, trust validation, verification, repair, and execution metadata.</p>

                    <p><strong>Parameters</strong></p>
                    <table class="params-table">
                        <thead><tr><th>Parameter</th><th>Type</th><th>Required</th><th>Description</th></tr></thead>
                        <tbody>
                            <tr><td><code class="param-name">prompt</code></td><td><span class="param-type">string</span></td><td><span class="param-required">required</span></td><td class="param-desc">Primary prompt text when sending a simple request.</td></tr>
                            <tr><td><code class="param-name">messages</code></td><td><span class="param-type">array</span></td><td><span class="param-optional">optional</span></td><td class="param-desc">Chat-style message array. If present, it is sent through the same orchestration path as /chat.</td></tr>
                            <tr><td><code class="param-name">X-API-Key header</code></td><td><span class="param-type">string</span></td><td><span class="param-required">required</span></td><td class="param-desc">Your API key in request headers (Authorization Bearer also supported).</td></tr>
                        </tbody>
                    </table>

                    <p style="margin-top:16px"><strong>Response shape</strong></p>
                    <p>In addition to <code>response</code>, the API can return orchestration fields such as <code>thinking</code>, <code>reasoning</code>, <code>execution</code>, <code>trust</code>, <code>verification</code>, <code>telemetry</code>, and a raw <code>chat</code> envelope mirroring the main chat surface.</p>
  ...
  <span class="key">"response"</span>: <span class="str">"...final reply..."</span>,
  <span class="key">"thinking"</span>: <span class="str">"...optional reasoning summary..."</span>,
  <span class="key">"execution"</span>: { <span class="key">"trace_id"</span>: <span class="str">"..."</span> },
  <span class="key">"trust"</span>: { <span class="key">"route_class"</span>: <span class="str">"STANDARD"</span> },
  <span class="key">"verification"</span>: { <span class="key">"passed"</span>: <span class="kw">true</span> },
  <span class="key">"telemetry"</span>: { <span class="key">"request_id"</span>: <span class="str">"..."</span> },
  <span class="key">"meta"</span>: {
    <span class="key">"orchestration"</span>: { <span class="key">"mode"</span>: <span class="str">"chat_orchestrator"</span> }
  }
}</code></pre>
                    </div>
                </div>
...
X-RateLimit-Reset: 1740873600</code></pre>
            ...
            <table class="rate-table" style="margin-top:16px">
                ...
                <tbody>
                    ...
                    <tr><td><span class="plan-pill pill-enterprise">Enterprise</span></td><td>10,000</td><td class="param-desc">$30/mo — LLaMA 70b access + recommended for production operator deployments</td></tr>
                </tbody>
            </table>
            <p><a href="/pages/pricing" style="color:var(--accent-light)">View operator tiers →</a></p>
        </div>
                ...
                <div class="endpoint-body">
                    ...
                    <table class="params-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><code class="param-name">X-API-Key header</code></td>
                                <td><span class="param-type">string</span></td>
                                <td><span class="param-required">required</span></td>
                                <td class="param-desc">Your API key in request headers (Authorization Bearer also supported).</td>
                            </tr>
                            <tr>
  ...
  <span class="key">"meta"</span>: {
    ...
    <span class="key">"requests_remaining"</span>: <span class="num">96</span>
        ...
        <div class="doc-section" id="benchmark">
            <h2>Public Benchmark API</h2>
            <div class="section-sub">Unauthenticated benchmark traversal through the canonical public API</div>

            <div class="callout">
                <strong>No API key required</strong>
                These benchmark routes are public so anyone can inspect run metadata, paging, per-task artifacts, and scoring outputs.
            </div>

            <table class="params-table">
                <thead><tr><th>Route</th><th>Description</th></tr></thead>
                <tbody>
                    <tr><td><code class="param-name">/api/public_api.php?action=benchmark_overview</code></td><td class="param-desc">Top-level benchmark metadata, weights, averages, and route discovery.</td></tr>
                    <tr><td><code class="param-name">/api/public_api.php?action=benchmark_tasks&amp;limit=25&amp;offset=0</code></td><td class="param-desc">Paged task index with status, scores, and artifact links.</td></tr>
                    <tr><td><code class="param-name">/api/public_api.php?action=benchmark_task&amp;task_id=T001</code></td><td class="param-desc">Single task with full embedded artifacts.</td></tr>
                    <tr><td><code class="param-name">/api/public_api.php?action=benchmark_all&amp;limit=10&amp;offset=0&amp;include_artifacts=1</code></td><td class="param-desc">Paged full traversal with optional embedded artifacts.</td></tr>
                    <tr><td><code class="param-name">/api/public_api.php?action=benchmark_file&amp;path=scoring/T001.json</code></td><td class="param-desc">Direct artifact passthrough for task, scoring, output, or external template files.</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="doc-section" id="example-curl">
            ...
            <div class="code-block" id="example-curl">
                ...
                <pre><code>curl -G https://lyralinkai.com/api/public_api.php \
  --data-urlencode <span class="str">"q=how does AI work"</span> \
  -H <span class="str">"X-API-Key: lyr_your_key_here"</span> \
  -d <span class="str">"limit=3"</span></code></pre>
            </div>

                        <p><strong>Prompt orchestration</strong></p>
                        <div class="code-block">
                                <div class="code-block-header"><span class="code-lang">bash</span><button class="copy-code-btn" onclick="copyCode(this)">Copy</button></div>
                                <pre><code>curl https://lyralinkai.com/api/public_api.php?action=prompt \
    -H <span class="str">"Content-Type: application/json"</span> \
    -H <span class="str">"X-API-Key: lyr_your_key_here"</span> \
    -d '{
        <span class="key">"prompt"</span>: <span class="str">"Audit this deployment plan for rollback risk."</span>
    }'</code></pre>
                        </div>

                        <p><strong>Public benchmark overview</strong></p>
                        <div class="code-block">
                                <div class="code-block-header"><span class="code-lang">bash</span><button class="copy-code-btn" onclick="copyCode(this)">Copy</button></div>
                                <pre><code>curl https://lyralinkai.com/api/public_api.php?action=benchmark_overview</code></pre>
                        </div>
    ...
    <span class="str">'https://lyralinkai.com/api/public_api.php?q=how+does+AI+work&limit=3'</span>,
...
response = requests.get(
    <span class="str">"https://lyralinkai.com/api/public_api.php"</span>,
    ...
    print(<span class="str">f"Score: {result['score']} via {result['method']}"</span>)</code></pre>
        ...
        <div class="cta-bar">
            <div>
                ...
                <p>Generate your API key and integrate into your operator stack in minutes.</p>
            </div>
            <a href="/pages/api_keys.php" class="btn btn-primary">Get your API key →</a>
        </div>
...
const links     = document.querySelectorAll('.doc-sidebar a, .mobile-toc a');
