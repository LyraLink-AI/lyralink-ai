...
- Posts a once-per-day security summary embed into the same bot logs channel.
- Detection patterns:
...
- Added explicit Security Policy and Accessibility Statement pages.
- Updated Privacy Policy and Terms of Service with a clearer prompt-handling warning and synchronized effective dates.
- Normalized onboarding/navigation links for API docs and API key management to explicit PHP routes.
- Added the new legal pages to the public sitemap.
